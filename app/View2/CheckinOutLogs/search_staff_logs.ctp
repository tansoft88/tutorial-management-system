...
<?php	echo $this->Form->create('CheckinOutLog',array('action' => 'search_staff_logs'));?>
	<fieldset>
	<legend><b><?php echo __('EMPLOYEE STATISTICS'); ?></b></legend>
	<table>
  <tr><th>
...
<fieldset>
	...
	<th width="18%" style="white-space:nowrap;"><?php echo __('Check In User'); ?></th>
	<th width="18%" style="white-space:nowrap;"><?php echo __('Check Out User'); ?></th>
	<?php 
	if($username == 'tmutero'){?>
...
?>
	...
	<td><?php echo $data[$i]['checkin_user'] ?></td>
	<td><?php echo $data[$i]['checkout_user'] ?></td>
		<?php 
	if($username == 'tmutero'){?>
