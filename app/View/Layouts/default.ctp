...
<title>TUTORIALS SYSTEM:: <?php echo $title_for_layout?></title>
</head>
...
<ul>
		...
		<?php echo $this->Html->link(__('Make Payment To Submit Assignment'), array('controller'=>'users','action' => 'index')); ?>||
		<?php echo $this->Html->link(__('Change Password'), array('controller'=>'users','action' => 'admin_password')); ?>||
		<?php echo $this->Html->link(__('View Assignment History'), array('controller'=>'users','action' => 'admin_password')); ?>
		 </h4>
		<?php }?>	
		</ul>
...
<ul>
		...
		<?php echo $this->Html->link(__('Manage Students'), array('controller'=>'staff_details','action' => 'add_stud')); ?>||
		<?php echo $this->Html->link(__('List Students'), array('controller'=>'staff_details','action' => 'index_stud')); ?>||
...
<?php
	...
	?>
Copyright &copy; <?php echo date('Y'); ?> Tutorials System v1.0.1
</div>
