...
<?php echo $this->Form->create('FileUpload');?>
	...
	<?php
		...
		//echo "<br>";
		//echo $this->Form->label('Client Organization<font color=red>*</font>');
	 	//echo $this->Form->select('client_organization_id',$clientOrganizations,array('empty'=>'Please Select','selected'=>false));
